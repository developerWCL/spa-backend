 ...
 * Sent to guest when admin updates booking status to "cancelled".
 */
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td style="text-align:right;vertical-align:middle;">
                    <p style="margin:0;color:${PRIMARY};font-size:13px;font-weight:600;">Booking Cancelled</p>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding:36px 40px;">
              ...
              <p style="margin:0 0 24px;color:#6b7280;font-size:14px;line-height:1.6;">
                We regret to inform you that your booking has been cancelled. Please contact us if you have any questions.
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background:${LIGHT_BG};border-radius:6px;margin-bottom:24px;">
                <tr>
                  ...
                  <td style="padding:16px 20px;text-align:right;vertical-align:middle;">
                    <span style="background:#dc2626;color:#fff;padding:4px 12px;border-radius:20px;font-size:12px;font-weight:600;">CANCELLED</span>
                  </td>
                </tr>
              </table>
              ...
              <p style="margin:0;color:#6b7280;font-size:13px;line-height:1.6;">
                If you would like to rebook your appointment or have any questions regarding this cancellation, please don't hesitate to contact us.
              </p>
            </td>
          </tr>
