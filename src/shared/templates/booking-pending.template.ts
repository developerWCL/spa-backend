/**
 * Email template: Booking Received (pending confirmation)
 * Sent to guest immediately after booking is created.
 */
export function bookingPendingTemplate(data: {
          ...
          <tr>
            <td style="padding:36px 40px;">
              ...
              <p style="margin:0 0 24px;color:#6b7280;font-size:14px;line-height:1.6;">
                Thank you for your booking. We have received your request and our team will confirm it shortly.
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background:#dcfce7;border-radius:6px;margin-bottom:24px;">
                <tr>
                  <td style="padding:16px 20px;">
                    <p style="margin:0;color:#15803d;font-size:14px;font-weight:600;">You got promotion: <strong>${data.promotionName}</strong> (${data.promotionCode})</p>
                  </td>
                </tr>
              </table>
              ` : ''}
              ...
              <p style="margin:0;color:#6b7280;font-size:13px;line-height:1.6;">
                We will send you a confirmation email once your booking is reviewed. If you have any questions, please contact us.
              </p>
            </td>
          </tr>
